...
- `asc stats [--live] [--sort cpu|mem]` — потребление CPU, памяти, диска и сети по приложениям (аналог `docker stats`, см. [📊 monitoring](/ru/cli/monitoring)).
...
- **Установка = клонирование репозитория** пакета в `repository/`; переключение версии — checkout нужного git-тега (подробнее — [📦 package-manager](/ru/cli/package-manager)).
...
- **Логи**: единый интерфейс — docker logs / journald / файл; стрим наружу через [🖥️ console](/ru/cli/console).
...
DMN-002, DMN-004, DMN-019, DMN-044, DMN-051, DMN-053, DMN-102, DMN-104, DMN-105, DMN-112, DMN-113, FE-005, FE-108, NODE-039, BE-040, FE-110, NODE-044, BE-008, FE-024 в [ROADMAP.md](https://github.com/AdminServiceCloud/asc-platform/blob/main/ROADMAP.md).
