...
const cliSidebarEn = [
  {
    ...
    items: [
      ...
      { text: "Files", link: "/cli/files" },
      { text: "User management", link: "/cli/user-management" },
      { text: "Console", link: "/cli/console" },
      { text: "Scheduler", link: "/cli/scheduler" },
      { text: "Web server", link: "/cli/webserver" },
...
const cliSidebarRu = [
  {
    ...
    items: [
      ...
      { text: "Файлы", link: "/ru/cli/files" },
      { text: "Управление пользователями", link: "/ru/cli/user-management" },
      { text: "Консоль", link: "/ru/cli/console" },
      { text: "Планировщик", link: "/ru/cli/scheduler" },
      { text: "Веб-сервер", link: "/ru/cli/webserver" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "schedule", link: "/ru/commands/schedule" },
      { text: "web", link: "/ru/commands/web" },
